...
// Grayscale dialtion a 2D image.
// Dilation is the basic morphological operation. 
//
// dilation(imgO, imgI, mask, siz, kernel) computes an image 
// where a given pixel is the minimum value of the pixel 
